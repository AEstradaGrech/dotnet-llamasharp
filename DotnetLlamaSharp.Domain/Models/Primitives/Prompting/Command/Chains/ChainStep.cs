...
namespace DotnetLlamaSharp.Domain.Models.Primitives.Prompting.Command.Chains
{
    public class ChainStep : IChaineable
    {
        ...
        public ChainStep(IJsoneable command, PromptCommandRequest request, string? feedFwdInstruction = null)
        {
            _command = command;
            _request = request;
        ...
        public async Task<ChainResult> ExecuteChainAsync(bool withUserFriendlyMessage = true)
        {
...
";   
        ...
        public IChaineable ExpandTo(IJsoneable command, PromptCommandRequest request, string? feedForwardInstruction = null)
            => Activator.CreateInstance(this.GetType(), command, request, feedForwardInstruction) as IChaineable;
