...
namespace DotnetLlamaSharp.Mappers
{
    public class EmbeddingsMappingProfile : Profile
    {
        public EmbeddingsMappingProfile()
        {
            ...
            CreateMap<ChromaFilesCollection, ChromaCollectionDto>()
            ...
            //CreateMap<FileChunksCollection, ChunksCollectionDto>()
            //    .IncludeBase<ChromaFilesCollection, ChromaCollectionDto>();
